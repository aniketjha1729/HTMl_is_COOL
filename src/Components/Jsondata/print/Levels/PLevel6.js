                                    ...
                                    <tbody>
                                        {columns.map((tablerow, tablerowindex) => {
                                            return <tr key={tablerowindex}>{rows.map((tablecolumn, tablecolumnindex) => {
                                                return <td id={textdata} onClick={textdata === order[1] ? firststep : nextstep} className="btn3d" key={tablecolumnindex} style={{ backgroundColor: blockColor[textdata], width: '100px', height: "100px", borderRadius: "10px", position: "relative"  }}>

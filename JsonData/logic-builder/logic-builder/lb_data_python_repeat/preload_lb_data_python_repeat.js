...
preload.prototype = {
	...
	{ 
        ...
        for(var i = 1 ; i <= totalLevel;i++){
            this.game.load.json('level'+i, '/static/lb_data_python_repeat/level'+i+'.json?v='+randomnumber); 
                                }

		this.game.load.json('ainfo', '/static/lb_data_python_repeat/ainfo.json?v='+randomnumber); 

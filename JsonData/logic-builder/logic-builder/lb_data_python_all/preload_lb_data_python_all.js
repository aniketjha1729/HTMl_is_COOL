...
preload.prototype = {
	...
	{ 
		...
		this.game.load.json('ainfo', '/static/lb_data_python_basics/ainfo.json?v='+randomnumber); 

		var logo = this.game.add.sprite(this.game.width/2, this.game.height * 0.35,"logo");
		logo.anchor.set(0.5)
		var loadingBarBg = this.add.sprite(this.game.width * 0.365 , this.game.height * 0.425, "reloaderBarBg");

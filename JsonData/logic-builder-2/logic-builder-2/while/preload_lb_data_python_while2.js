...
preload.prototype = {
	...
	{ 
        ...
        for(var i = 1 ; i <= totalLevel;i++){
            this.game.load.json('level'+i, '/static/lb_data_python_while2/level'+i+'.json?v='+randomnumber); 
        }

		this.game.load.json('ainfo', '/static/lb_data_python_while2/ainfo.json?v='+randomnumber); 
